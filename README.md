...
| `energy_map.html` | Interactive US energy generation map (D3.js + TopoJSON + EIA data 1990–2023) |
| `photo.jpg` | Profile photo |
| `MaharshiRohithDonthi_Resume.pdf` | Resume (downloadable from the site) |
...
End-to-end underwriting pipeline: calibrated PD model → PDO/ODDS scorecard → APPROVE/REVIEW/DECLINE decision with reason codes → PSI drift monitoring. Built on synthetic Metro 2®-style bureau data.
- AUC 0.87 · KS 0.42 · $180K annualized savings
...
Plain HTML · CSS · Vanilla JavaScript · D3.js · TopoJSON · GitHub Pages
...
- 🔗 [linkedin.com/in/rohith-donthi](https://www.linkedin.com/in/rohith-donthi)
- 💻 [github.com/rohithdonthi](https://github.com/rohithdonthi)
